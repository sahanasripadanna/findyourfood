...
function postToPopUp(keyWord){
  ...
  if(keyWord.search("School Lunch") !== -1){
    ...
    bodyText.innerHTML+='<div style = "float : left; width: 40%;" id ="popCol">';
    let popColumn = document.getElementById('popCol');
    popColumn.innerHTML+= 'This is an autogenerated generic food item of America fast food.<br>'
    ...
    bodyText.innerHTML+= '<img src = "fastfood.png" alt = "fast food" style = "width : 30%; height : 30%; display : inline;">';
    ...
    bodyText.innerHTML+= '<img src = "restaurant_food.png" alt = "restaurant food" style = "width : 50%; height : 30%; display : inline;">';
  }else {
    bodyText.innerHTML+="";
    addImage(keyWord);
    getDetails(keyWord);
